...
const About: React.FC = () => {
    return (
        ...
        >
            <Navbar />
            <div className="flex flex-col items-center justify-center w-[90%] sm:w-[70%] md:w-[60%] lg:w-[50%] p-6 sm:p-8 lg:p-10 bg-secondaryBackground rounded-lg text-text text-center mt-24">
